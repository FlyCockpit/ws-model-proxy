...
| `/{lang}/dashboard/pools/{poolId}/fallback` | Owner-only public fallback and overflow providers, plus the external-equivalent model picker (OpenRouter catalog; declaring one is the owner's BYOK consent). |
